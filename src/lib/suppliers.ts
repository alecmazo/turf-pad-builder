...
export const SUPPLIER_GROUPS: SupplierGroup[] = [
  ...
  },
  {
    ...
    tip: "Pressure-treated 4×4 posts + 2×6 rails. Hot-dip galvanized or structural exterior screws for Trex.",
    options: [
      {
        vendor: "Home Depot",
        product: "Pressure-treated lumber",
        url: "https://www.homedepot.com/b/Lumber-Composites-Lumber-Pressure-Treated-Lumber/N-5yc1vZaq1w",
        priceNote: "4×4 & 2×6 — compare green vs brown",
        area: "San Rafael #657 BOPIS",
        best: true,
      },
      {
        vendor: "Home Depot",
        product: "Exterior structural screws / lags",
        url: "https://www.homedepot.com/b/Hardware-Fasteners-Screws/N-5yc1vZc28m",
        priceNote: "Use exterior-rated only",
        area: "San Rafael #657 BOPIS",
      },
      {
        vendor: "Lowe's",
        product: "PT lumber & deck fasteners",
        url: "https://www.lowes.com/pl/Pressure-treated-lumber-Lumber-Building-supplies/4294857977",
