  ...
  const phases: BuildPhase[] = [
    ...
    },
    {
      ...
      steps: [
        ...
        '12 in clean-rock chimney right behind the wall (fill side)',
        '4" perforated collector at the base of that chimney — runs along the wall, not under the pad',
        "Leave a solid-outlet stub at the low end of the collector (daylights downhill)",
    ...
    },
    {
      ...
      steps: [
        "Confirm both wall perfs pitch ~1% to the outlet end (same side)",
        'Tie collector + interceptor into one solid 4" outlet with fittings',
        "Solid outlet runs along the side of the pad — not under the turf pitch",
        "Daylight downhill below the front wall (or tie to existing drain)",
      ],
    },
    {
      id: 6,
